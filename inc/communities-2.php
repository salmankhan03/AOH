...
<body>
    ...
    <div class="container space ">
        <div>
            <h2 style="font-size: 48pt !important;">Our trophied accomplishments</h2>
        </div>
    </div>
    <div class="container my-5 sm-my-3">
        <div class="row  space">
            <div class="col-lg-6 col-sm-12">
                <div class="img">
                    <img src="https://bridge439.qodeinteractive.com/wp-content/uploads/2021/07/home-image-3-parallax.jpg" alt="" width="100%">
                </div>
        ...
        <div class="row  space">
            <div class="col-lg-6 col-sm-12">
                <div class="img">
                    <img src="https://bridge439.qodeinteractive.com/wp-content/uploads/2021/07/services-image-2.jpg" alt="" width="100%">
                </div>
